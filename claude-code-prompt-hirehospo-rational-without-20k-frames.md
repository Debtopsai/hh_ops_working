...
| `frames/04-hero-plinth.html` | Proof 1 0:08–0:11.5 | 3.5s | `RATIONAL · COMBI OVEN` · `Delivered, installed & serviced by Washpro` · `REFURBISHED · WITH WARRANTY` | Real Rational combi cut-out settles on brushed-steel plinth (0.5s); refurb badge stamps on at 0:10.5 (flame) |
