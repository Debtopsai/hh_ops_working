...
> and any HireHospo brand assets (kit, wordmark, product photos, catalogue export) present;
...
## 3. Inputs - the script + storyboard (build spec) · any HireHospo kit/brand assets in the folder (source of truth if present) · `references/catalogue.md` (or the live site) for real product names/prices.
