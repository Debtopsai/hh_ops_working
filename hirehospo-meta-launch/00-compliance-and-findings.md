...
> **INPUT 1 — Daily budget: NZD $20/day (≈ $600/month, ≈ $140/week). Confirmed by the operator.** This is a very lean paid-social budget and it *intensifies* every constraint in this pack: it makes the single-ad-set structure mandatory (not just advisable), puts learning-phase exit effectively out of reach, and means you should expect to run **one ad at a time**, not two in rotation. `01` and `04` are built on this figure (and Auckland) — the single-ad-set / one-ad-at-a-time structure, the volume maths and the KPI ranges all reflect $20/day.
>
> **INPUT 2 — Geography: Auckland only. Confirmed by the operator (targets Auckland, services Auckland).** Tighter than the earlier nationwide assumption, and it matters twice over: the addressable hospitality-operator pool is now a single metro, so the audience is small and **frequency climbs fast** — lean hard on broad targeting and a steady creative refresh (see `01`/`04`). All delivery/install copy says **Auckland**, not NZ.
>
...
- **$4.66/day is for the cheap categories** (glasswasher, hot plate, small fryer). **For premium gear, pair the big capital number with its real daily figure as a value comparison** — e.g. *"A $20,000 Rational combi. From $17.30/day +GST."* The lowest Rational combi is **$121.09/week +GST**, and $121.09 ÷ 7 = **$17.30/day**. This is the operator's preferred frame for premium gear and **supersedes the earlier "never a daily number on premium gear" guidance** — pairing the $20k against the tiny daily figure *is* the value story. Verify the figure against live stock like any price.
