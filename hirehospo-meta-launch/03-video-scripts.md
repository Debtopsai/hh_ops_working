...
**Aspect ratios:** 9:16 (1080×1920) primary; 4:5 (1080×1350) for Feed. **Reels safe zones:** clear the **top ~250px** and **bottom ~420px**; hero elements in the central band. **CTA end card: "Apply Now"** (see the destination caveat in `02`).

---

## Hooks — generated, scored, ranked

Scored 0–10 on **Clarity · Relevance · Novelty · Specificity · Credibility** (total /50). Under 28 is rewritten or dropped. Scripts build from the top scorers.

### Concept 1 — Value (10 hooks, 4 archetypes)

| Rank | Hook | Archetype | Cl | Re | No | Sp | Cr | **/50** |
|---|---|---|---|---|---|---|---|---|
| 1 | "A Rational combi in your kitchen — without the $20,000 up front." | Specific truth | 8 | 9 | 8 | 9 | 8 | **42** |
| 2 | "The European brands you'd never buy new — now on low weekly payments." | Contrarian truth | 8 | 9 | 8 | 8 | 8 | **41** |
| 3 | "Your whole kitchen. From $4.66/day +GST." | Specific truth | 9 | 9 | 6 | 9 | 8 | **41** |
| 4 | "You don't need $20,000 to run a $20,000 kitchen." | Contrarian truth | 8 | 9 | 8 | 7 | 8 | **40** |
| 5 | "Kit out your kitchen for less than a flat white a day." | Curiosity gap | 8 | 9 | 6 | 8 | 8 | **39** |
| 6 | "Your cash is worth more in the till than in a $20k oven." | Contrarian truth | 7 | 8 | 7 | 6 | 7 | **35** |
| 7 | "Let the equipment pay for itself." | Curiosity gap (brand hero) | 8 | 9 | 6 | 5 | 7 | **35** |
| 8 | "From start-ups to legacies — we've got your back." | Curiosity gap (brand) | 8 | 8 | 6 | 4 | 7 | **33** |
| 9 | "Buying kitchen equipment outright is the most expensive way to open." | Common mistake | 7 | 8 | 7 | 5 | 6 | **33** |
| 10 | "The reason your competitor's kitchen looks brand new." | Curiosity gap | 6 | 7 | 7 | 4 | 5 | **29** |

**Build from:** #1 (value comparison), #3 (price), #2 (premium-brand access).

### Concept 2 — Speed (10 hooks, 4 archetypes)

| Rank | Hook | Archetype | Cl | Re | No | Sp | Cr | **/50** |
|---|---|---|---|---|---|---|---|---|
| 1 | "Most applications under $25k — approved in 3 business days." | Specific truth | 8 | 8 | 6 | 9 | 9 | **40** |
| 2 | "Fryer dies mid-service. How fast can you replace it?" | High-stakes warning | 8 | 9 | 7 | 6 | 8 | **38** |
| 3 | "Apply in 5 minutes. Machines on their way in days." | Specific truth | 8 | 8 | 6 | 7 | 8 | **37** |
| 4 | "Not sure you'll qualify? One quick way to find out." | Myth-bust / honesty | 8 | 8 | 8 | 5 | 8 | **37** |
| 5 | "Simple as 1, 2, 3: apply, choose, take delivery." | Specific truth (brand) | 9 | 8 | 5 | 7 | 8 | **37** |
| 6 | "New machines in stock — in your kitchen in days, not months." | Specific truth | 8 | 8 | 6 | 7 | 7 | **36** |
| 7 | "Waiting weeks for finance is why kitchens miss the season." | Common mistake | 7 | 8 | 6 | 5 | 6 | **32** |
| 8 | "The equipment you need shouldn't wait on a slow yes or no." | High-stakes warning | 7 | 8 | 6 | 4 | 6 | **31** |
| 9 | "See how fast a new combi could be in your kitchen." | Curiosity gap | 7 | 8 | 5 | 5 | 6 | **31** |
| 10 | "From enquiry to installed — faster than you'd think." | Curiosity gap | 7 | 7 | 5 | 5 | 5 | **29** |

**Build from:** #1 (3-day approval), #2 (fryer high-stakes), #5 (simple as 1,2,3).

---

## Concept 1 scripts (3 × ~10–11s)

### C1-A — "$20k Rational, without the $20k" (11s) · from hook #1 · premium equipment / value
| t | On-screen text | VO / caption | Visual | Build |
|---|---|---|---|---|
| 0.0–2.5 | **$20,000** · *for one oven* | "Twenty grand. For one oven." | Mono number counts up on dark steel | Motion graphics |
...
| 9.0–11.0 | **Apply Now** · *5-minute application · see if you qualify* | "Apply in five minutes." | End card: wordmark + Apply Now pill + hirehospo.com | Motion graphics |

### C1-B — "$4.66 a day" (10s) · from hook #3 · new cafe / price
| t | On-screen text | VO / caption | Visual | Build |
|---|---|---|---|---|
| 0.0–2.5 | **From $4.66/day +GST** *· less than a flat white* | "Kit out your kitchen from four sixty-six a day, plus GST." | Big mono price on dark steel; flame under "$4.66" | Motion graphics |
...
| 9.0–10.0 | **Apply Now** · *5-minute application* | "Apply in five minutes." | End card + Apply Now pill | Motion graphics |
...
| 9.5–11.0 | **Apply Now** · *see if you qualify* | "See if you qualify." | End card + Apply Now pill | Motion graphics |

---

## Concept 2 scripts (3 × ~10–11s)

### C2-A — "Approved in 3 business days" (11s) · from hook #1 · honest speed champion
| t | On-screen text | VO / caption | Visual | Build |
|---|---|---|---|---|
...
| 9.5–11.0 | **Apply Now** · *5-minute application* | "Apply in five minutes." | End card + Apply Now pill + hirehospo.com | Motion graphics |

### C2-B — "Fryer dies mid-service" (10s) · from hook #2 · high-stakes
| t | On-screen text | VO / caption | Visual | Build |
|---|---|---|---|---|
| 0.0–3.0 | **Your fryer dies mid-service.** | "Your fryer dies, mid-service." | Tight B-roll: a dark/cold fryer, a full docket rail; red flicker | **Shoot at a real kitchen** (or licensed B-roll) |
...
| 9.0–10.0 | **Apply Now** · *we've got your back* | — | End card + Apply Now pill | Motion graphics |

### C2-C — "Simple as 1, 2, 3" (11s) · from hook #5 · process ease
| t | On-screen text | VO / caption | Visual | Build |
|---|---|---|---|---|
| 0.0–3.0 | **Simple as 1, 2, 3.** | "Simple as one, two, three." | "1 · 2 · 3" builds on dark steel | Motion graphics |
...
| 9.0–11.0 | **Apply Now** · *see if you qualify* | "See if you qualify." | End card + Apply Now pill | Motion graphics |

---

## Production summary — what to shoot vs build
