...
*10–12 second ads. At this length the hook is 2–3s, the body 5–6s, the CTA 1–2s, and there is no room for a bridge — the product lands at ~70–85% through. **Assume every ad is watched muted:** burned-in captions are mandatory and the on-screen text must carry the whole message with the sound off. HireHospo runs person-free by default (motion graphics over real catalogue stills + a little kitchen B-roll), which also keeps a first-launch shoot cheap.*

**Aspect ratios:** 9:16 (1080×1920) primary for Reels/Stories; 4:5 (1080×1350) for Feed. **Reels safe zones:** keep all text and key elements out of the **top ~250px** (profile/audio UI) and the **bottom ~420px** (caption, CTA, handle) — hero elements live in the central ~1080×1250 band. Stories: bottom ~250px clear. 4:5 Feed is more forgiving but keep text in the central 80%.

---

## Hooks — generated, scored, ranked

Scored 0–10 on **Clarity · Relevance · Novelty · Specificity · Credibility** (total /50). Anything under 28 is rewritten or dropped, not shown. Scripts are built from the top scorers.
...
| Rank | Hook | Archetype | Cl | Re | No | Sp | Cr | **/50** |
|---|---|---|---|---|---|---|---|---|
| 1 | "A credit decision in 24–48 hours. Not 24–48 days." | Specific truth | 9 | 8 | 7 | 9 | 8 | **41** |
| 2 | "Fast finance doesn't mean easy approval. We're credit-led." | Contrarian / honesty | 8 | 8 | 9 | 6 | 9 | **40** |
...
**Build from:** #1 (24–48h), #2 (credit-led honesty), #4 (fryer dies). All ≥28.
...
### C2-A — "24–48 hours" (11s) · from hook #1 · the honest speed champion
...
The one script where a little real B-roll earns its keep — the opening should feel like a real kitchen under pressure.

| t | On-screen text | VO / caption | Visual | Build |
|---|---|---|---|---|
| 0.0–3.0 | **Your fryer dies mid-service.** | "Your fryer dies, mid-service." | Tight B-roll: a dark/cold fryer, a docket rail full; red flicker | **Shoot at Washpro** (or licensed kitchen B-roll) |
