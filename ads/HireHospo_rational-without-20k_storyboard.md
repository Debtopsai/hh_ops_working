...
| `frame-refurb-badge` | Shot 8 | (overlay) | `REFURBISHED · WITH WARRANTY` | Stamp settle: scale 1.08 → 1.0 in 0.25s, 2° rotate correction | **REUSED** unchanged. This frame's one flame highlight |
