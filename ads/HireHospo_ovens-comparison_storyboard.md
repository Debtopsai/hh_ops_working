# Storyboard - HireHospo "Get The Oven You Really Want" - 16s - Comparison, fast cut (no people)

**Script:** `HireHospo_ovens-comparison_script_16s.md` · **Cafe / bakery operator, Product Aware, offer-led comparison**
**Total shots:** 11 · **9:16 (1080×1920)** · dark steel (provisional system; canvas #12141A)
**Product:** Turbofan E31D4 · Convection Ovens · buy **~$6,550** ⚠ · **from $5.90/day** ⚠

## Shot list

| # | Time | Shot | Visual | On screen | VO | SFX | Cut |
|---|---|---|---|---|---|---|---|
| 1 | 0:00-0:01 | EQUIP hero | Turbofan E31D4 cut-out centre on a brushed-steel plinth. **Hard light-up, not a fade** | `TURBOFAN E31D4` | "Same oven." | Oven-door thunk, lighter than the combi ad (−15dB) | Hard cut |
...
| 3 | 0:02.5-0:04 | GFX price A | **$6,550** slams into the left head. Right column still empty | **$6,550** *(mono)* | *(price line)* | Till tick (−16dB) | Hard cut |
| 4 | 0:04-0:06 | GFX price B | **FROM $5.90/DAY** slams into the right head in flame. Table frame draws between the columns | **FROM $5.90/DAY** | *(price line)* | Till tick, warmer (−16dB) | Hard cut |
...
| 6 | 0:06.75-0:07.5 | **Row 2 (differs)** | Left cross `mute`, right tick `approve` | `6.5K OUT OF YOUR POCKET` ✗ ‖ `KEEP 6.5K IN YOUR POCKET` ✓ | - | Dry / warm tick | Hard cut |
...
| 9 | 0:09-0:11.5 | **TXT hero** | **The whole table clears.** Line takes full width on bare steel, then the two outcome lines fire beneath it 400ms apart | **GET THE OVEN YOU REALLY WANT** · `CONSISTENT BAKES, EVERY TRAY` · `PUT HOT FOOD ON THE MENU` | "Get the oven you really want." | Bed lifts one step, percussion pulls out. **No SFX under the line** | Hard cut |
| 10 | 0:11.5-0:13.5 | **TXT payoff** | `$6.5K` strikes through L→R as two benefit chips fire | **WITHOUT THE ~~$6.5K~~** *(flame)* · `KEEP YOUR CAPITAL` · `KEEP YOUR CASHFLOW` | *(payoff line)* | Strike (−14dB); two ticks | Hard cut |
