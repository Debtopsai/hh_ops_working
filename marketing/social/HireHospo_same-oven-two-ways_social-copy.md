...
That isn't the problem. The problem is $30,000 leaving the account in one
hit, in the same month as wages, stock and rent.
...
Rent: oven in your kitchen day one, $30,000 stays in your pocket.

Same machine. Same install. The only thing that moves is your capital.

Refurbished commercial kitchen equipment, financed on low weekly payments
+ GST. Get our latest stock list.
...
| Headline | Chars |
|---|---|
| Same oven. Two ways to pay. | 27 |
| Keep the $30,000. Get the oven. | 31 |
...
### Feed / Reels caption - A. APPROVED, USE THIS ONE
...
Two changes from the earlier draft, both client-directed: Washpro is no
